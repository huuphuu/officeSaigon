...
namespace PMSA.iMarkets.Service.Core.Class
{
    ...
    public class CTradeInterface
    {
        ...
        public string CSVFieldDJDs = "ID;SecuritiesCode;SideString;FilledUnits;FilledPrice;OrderTypeString;Durration;SecuritiesName;ExchangeCode;Type;CountryCode";
